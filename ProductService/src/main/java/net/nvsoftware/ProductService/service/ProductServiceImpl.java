...
public class ProductServiceImpl implements ProductService {
    ...
    public void reduceQuantity(long id, long quantity) {
        log.info("Start: ProductService reduceQuantity with id: " + id + " and quantity: " + quantity);

        ProductEntity productEntity = productRepository.findById(id)
                        .orElseThrow(() -> new RuntimeException("ProductService reduceQuantity not found with id: " + id));
        ...
        productRepository.save(productEntity);
        log.info("End: ProductService reduceQuantity with id: " + id + " and quantity: " + quantity);
    }
}
